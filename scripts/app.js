...
sun.addEventListener('click', function (e) {
    if (moon.src === moon.src) {
        ...
        day1box.className = "card borderR forecastOpacity2 hov4";
        day2box.className = "card borderR forecastOpacity2 hov4";
        day3box.className = "card borderR forecastOpacity2 hov4";
        day4box.className = "card borderR forecastOpacity2 hov4";
        day5box.className = "card borderR forecastOpacity2 hov4";
...
moon.addEventListener('click', function (e) {
    if (sun.src === sun.src) {
        ...
        day1box.className = "card borderR forecastOpacity hov";
        day2box.className = "card borderR forecastOpacity hov";
        day3box.className = "card borderR forecastOpacity hov";
        day4box.className = "card borderR forecastOpacity hov";
        day5box.className = "card borderR forecastOpacity hov";
