...
async function FiveDayApiCall(a, b, c) {
    ...
    let tempMax = Math.floor(KelvinConvert(HighTemp(data.list[0].main.temp_max, data.list[1].main.temp_max, data.list[2].main.temp_max, data.list[3].main.temp_max, data.list[4].main.temp_max, data.list[5].main.temp_max, data.list[6].main.temp_max, data.list[7].main.temp_max))) + "°F";
    ...
    let tempMax2 = Math.floor(KelvinConvert(HighTemp(data.list[8].main.temp_max, data.list[9].main.temp_max, data.list[10].main.temp_max, data.list[11].main.temp_max, data.list[12].main.temp_max, data.list[13].main.temp_max, data.list[14].main.temp_max, data.list[15].main.temp_max)));
    ...
    for(let i = 0; i < 7; i++){
        ...
        if(maxTemp === tempMax){
            ...
            console.log(ChangeIcon(data.list[i].weather[0].icon));
        }
    }
